...
def proxy_scrape():
    ...
    startTime = time.time()
    # create temp dir
    temp = getTempDir() + "\\Eclipse_proxies"
    print(
        f"{Fore.YELLOW}Please wait while the Eclipse Tool Scrapes proxies for you!{Fore.RESET}"
    )
    ...
    setTitle(f"Eclipse Tool {THIS_VERSION}")
